...
var bottomView = Ti.UI.createButton({
    title: "Aim your phone at the VIN barcode in the drive side door jamb",
    textAlign: 'center',
    color: '#fff', backgroundColor: '#000', style: 0,
...
overlay.add(bottomView);
var topView = Ti.UI.createButton({
    title: 'Scan VIN Barcode', textAlign: 'center',
    color: '#fff', backgroundColor: '#000', style: 0,
    font: { fontWeight: 'bold', fontSize: 16 },
