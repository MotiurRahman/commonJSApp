...
@interface commonJSAppObject : KrollCoverageObject {
#else
@interface commonJSAppObject : KrollObject {
#endif
@private
...
extern NSString * commonJSApp$ModuleRequireFormat;
...
@private
	...
	commonJSAppObject *_commonjsapp;
	KrollObject* console;
	BOOL shutdown;
