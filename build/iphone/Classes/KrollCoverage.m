...
+ (void)incrementCoverage:(NSString *)componentType_ componentName:(NSString *)componentName_
                  apiName:(NSString *)apiName_
             coverageType:(NSString *)coverageType_
                  apiType:(NSString *)apiType_
{
...
{
  [KrollCoverageObject incrementCoverage:COMPONENT_TYPE_OTHER
...
{
  [KrollCoverageObject incrementCoverage:componentType
...
- (id)initWithTarget:(id)target_ selector:(SEL)selector_
            argcount:(int)argcount_
                type:(KrollMethodType)type_
                name:(id)name_
             context:(KrollContext *)context_
              parent:(id<KrollCoverage>)parent_
{
...
- (id)call:(NSArray *)args
{
  ...
  [KrollCoverageObject incrementCoverage:[self coverageType]
                           componentName:[self coverageName]
                                 apiName:apiName
                            coverageType:coverageType
                                 apiType:apiType];
