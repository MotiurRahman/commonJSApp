...
(function (globalScope) {
  ...
  */
	Module.patch = function (globalCtx, url, port) {
		var defaultURL = process.platform === 'android' && process.hardware === 'sdk' ? '10.0.2.2' : Ti.Platform.model === 'Simulator' ? '127.0.0.1' : '192.168.0.3';
  ...
  */
	...
	Module.patch(globalScope, '192.168.0.3', '8324');
