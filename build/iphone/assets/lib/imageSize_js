    ...
    btnTransform.addEventListener('click', function(e) {
        switch (type) {
            ...
            case 6:
                ...
                break;
            case 7:
                newBlob = ImageFactory.imageTransform(blob, { type: ImageFactory.TRANSFORM_CROP, width: 200, height: 200 }, { type: ImageFactory.TRANSFORM_ROUNDEDCORNER, borderSize: 6, cornerRadius: 20 });
                break;
            case 8:
